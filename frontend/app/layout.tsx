  ...
  return (
    <html lang="ko" className="dark">
      <body className="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 antialiased selection:bg-indigo-300/30 dark:selection:bg-indigo-900/40 transition-colors duration-500">
        ...
        <div className="fixed inset-0 -z-50 pointer-events-none overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-700">
          <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vh] rounded-full bg-gradient-to-br from-indigo-500/30 dark:from-indigo-600/30 via-purple-500/20 dark:via-purple-700/20 to-transparent blur-[140px] animate-pulse-slow"></div>
          <div className="absolute top-[30%] right-[-10%] w-[50vw] h-[80vh] rounded-full bg-gradient-to-bl from-blue-400/30 dark:from-blue-600/30 via-cyan-400/20 dark:via-cyan-700/20 to-transparent blur-[160px] animate-pulse-slow" style={{ animationDelay: '3s' }}></div>
          <div className="absolute bottom-[-10%] left-[10%] w-[60vw] h-[60vh] rounded-full bg-gradient-to-tr from-emerald-500/20 dark:from-teal-600/20 via-slate-800/5 to-transparent blur-[150px] animate-pulse-slow" style={{ animationDelay: '5s' }}></div>
